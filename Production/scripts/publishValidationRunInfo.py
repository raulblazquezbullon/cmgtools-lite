...
def getValidationRunInfoFromDisk( validationRunPath ):
    ...
    for component_dir in component_dirs:
        ...
        with open(log_file, 'rb') as f: # here I am reading each component's log file to get all the component and analyzer info
            target_type = "";
            target_name = "";
	...
	exit( -1 )    
    try:
        showtagsFile = open( "Logger/logger_showtags.txt", 'rb' )
