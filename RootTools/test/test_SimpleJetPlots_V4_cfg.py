...
jetPlot = cfg.Analyzer(
    'SimpleJetPlots',
    ptCut = 10,
    genPtCut = 0,
    ## use pat::Jets
    YeCHSjetCollection = ('selectedPatJetsAK5','std::vector<pat::Jet>'),
    NoCHSjetCollection = ('selectedPatJetsAK5NoPUSub','std::vector<pat::Jet>'),
    YeCHSgenJetsCollection = (('selectedPatJetsAK5','genJets'),'vector<reco::GenJet>'),
    NoCHSgenJetsCollection = (('selectedPatJetsAK5NoPUSub','genJets'),'vector<reco::GenJet>'),
...
DYJetsFall11_PAT = cfg.MCComponent(
    ...
    files = getFiles('/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola/Fall11-PU_S6_START42_V14B-v1/AODSIM/V4/PAT_CMG_4_0_0', 'cmgtools', 'pat.*root')[:50],
    xSection = 3048.,
    nGenEvents = 34915945,
    triggers = [],
    effCorrFactor = 1 )
...
# DYJetsFall11_PAT.splitFactor = 1
