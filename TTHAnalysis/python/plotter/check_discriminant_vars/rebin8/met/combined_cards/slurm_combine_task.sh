...
if [ ${SLURM_ARRAY_TASK_ID} -eq 1 ]; then
  combine --algo grid --rMin 0 --rMax 6 -t -1 --setParameters r_prompt_WZ=1,r_prompt_ZZ=1 --redefineSignalPOI r_prompt_WZ -M MultiDimFit -m 125 -d workspace.root --points 200 -n nominal
fi
