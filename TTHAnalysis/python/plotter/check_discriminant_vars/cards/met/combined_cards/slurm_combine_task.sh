...
if [ ${SLURM_ARRAY_TASK_ID} -eq 20 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin10_fakes_TT --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin10_fakes_TT --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 21 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin10_prompt_WZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin10_prompt_WZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
...
if [ ${SLURM_ARRAY_TASK_ID} -eq 23 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin11_fakes_TT --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin11_fakes_TT --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 24 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin11_prompt_WZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin11_prompt_WZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 25 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin12_fakes_TT --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin12_fakes_TT --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 26 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin12_prompt_WZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin12_prompt_WZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 27 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin13_fakes_TT --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin13_fakes_TT --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 28 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin13_prompt_WZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin13_prompt_WZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
...
if [ ${SLURM_ARRAY_TASK_ID} -eq 30 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin14_prompt_WZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin14_prompt_WZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 31 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin18_fakes_TT --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin18_fakes_TT --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 32 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin18_prompt_WZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin18_prompt_WZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
...
if [ ${SLURM_ARRAY_TASK_ID} -eq 41 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin9_prompt_WZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin9_prompt_WZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 42 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin9_prompt_ZZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin9_prompt_ZZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
