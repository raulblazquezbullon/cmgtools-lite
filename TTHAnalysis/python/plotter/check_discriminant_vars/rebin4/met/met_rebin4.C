...
//=========  (Sun Feb 19 20:50:34 2023) by ROOT version 6.24/07
   ...
   met_rebin4_total__1->SetBinContent(1,269.1137);
   met_rebin4_total__1->SetBinContent(2,1062.738);
   met_rebin4_total__1->SetBinContent(3,877.2245);
   met_rebin4_total__1->SetBinContent(4,1175.171);
   met_rebin4_total__1->SetBinError(1,17.00731);
   met_rebin4_total__1->SetBinError(2,26.53645);
   met_rebin4_total__1->SetBinError(3,18.9305);
   met_rebin4_total__1->SetBinError(4,18.56458);
   met_rebin4_total__1->SetMinimum(0);
   met_rebin4_total__1->SetMaximum(2350.342);
   ...
   met_rebin4_stack_stack_1->SetMaximum(1233.929);
   ...
   met_rebin4_prompt_WZ_stack_5->SetBinContent(1,179.6962);
   met_rebin4_prompt_WZ_stack_5->SetBinContent(2,843.4259);
   met_rebin4_prompt_WZ_stack_5->SetBinContent(3,764.0158);
   met_rebin4_prompt_WZ_stack_5->SetBinContent(4,1041.337);
   met_rebin4_prompt_WZ_stack_5->SetBinError(1,6.064452);
   met_rebin4_prompt_WZ_stack_5->SetBinError(2,13.1385);
   met_rebin4_prompt_WZ_stack_5->SetBinError(3,12.5047);
   met_rebin4_prompt_WZ_stack_5->SetBinError(4,14.59882);
   ...
   met_rebin4_total__2->SetBinContent(1,269.1137);
   met_rebin4_total__2->SetBinContent(2,1062.738);
   met_rebin4_total__2->SetBinContent(3,877.2245);
   met_rebin4_total__2->SetBinContent(4,1175.171);
   met_rebin4_total__2->SetBinError(1,17.00731);
   met_rebin4_total__2->SetBinError(2,26.53645);
   met_rebin4_total__2->SetBinError(3,18.9305);
   met_rebin4_total__2->SetBinError(4,18.56458);
   met_rebin4_total__2->SetMinimum(0);
   met_rebin4_total__2->SetMaximum(2350.342);
   ...
   Graph_met_rebin4_total_errors3001->SetMinimum(99.79232);
   Graph_met_rebin4_total_errors3001->SetMaximum(1398.664);
