...
//=========  (Sun Feb 19 16:03:55 2023) by ROOT version 6.24/07
   ...
   Graph_m3l_rebin4_total_errors3001->SetMinimum(293.3583);
   Graph_m3l_rebin4_total_errors3001->SetMaximum(1251.838);
