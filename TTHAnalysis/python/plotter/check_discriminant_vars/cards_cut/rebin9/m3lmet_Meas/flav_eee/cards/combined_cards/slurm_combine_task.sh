...
cd /nfs/fanae/user/rblazquez/TFG/wz_run3/CMSSW_12_4_12/src/CMGTools/TTHAnalysis/python/plotter/check_discriminant_vars/cards_cut/rebin9/m3lmet_Meas/flav_eee/cards/combined_cards
...
if [ ${SLURM_ARRAY_TASK_ID} -eq 26 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin2_fakes_DY --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin2_fakes_DY --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 27 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin2_fakes_TT --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin2_fakes_TT --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 28 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin2_prompt_WZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin2_prompt_WZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 29 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin2_prompt_ZZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin2_prompt_ZZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
...
if [ ${SLURM_ARRAY_TASK_ID} -eq 35 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin5_fakes_DY --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin5_fakes_DY --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 36 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin5_fakes_TT --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin5_fakes_TT --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 37 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin5_prompt_WZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin5_prompt_WZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 38 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin5_prompt_ZZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin5_prompt_ZZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 39 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin6_fakes_DY --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin6_fakes_DY --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 40 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin6_fakes_TT --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin6_fakes_TT --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 41 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin6_prompt_WZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin6_prompt_WZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 42 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin6_prompt_ZZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin6_prompt_ZZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 43 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin7_fakes_DY --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin7_fakes_DY --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 44 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin7_fakes_TT --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin7_fakes_TT --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 45 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin7_fakes_VV --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin7_fakes_VV --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 46 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin7_prompt_WZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin7_prompt_WZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 47 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin7_prompt_ZZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin7_prompt_ZZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
