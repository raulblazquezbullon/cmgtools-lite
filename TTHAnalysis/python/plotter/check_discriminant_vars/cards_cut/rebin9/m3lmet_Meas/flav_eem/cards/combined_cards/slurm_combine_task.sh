...
cd /nfs/fanae/user/rblazquez/TFG/wz_run3/CMSSW_12_4_12/src/CMGTools/TTHAnalysis/python/plotter/check_discriminant_vars/cards_cut/rebin9/m3lmet_Meas/flav_eem/cards/combined_cards
...
if [ ${SLURM_ARRAY_TASK_ID} -eq 34 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin4_fakes_DY --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin4_fakes_DY --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 35 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin4_fakes_TT --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin4_fakes_TT --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 36 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin4_prompt_WZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin4_prompt_WZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 37 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin4_prompt_ZZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin4_prompt_ZZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
...
if [ ${SLURM_ARRAY_TASK_ID} -eq 41 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin8_fakes_DY --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin8_fakes_DY --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 42 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin8_fakes_TT --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin8_fakes_TT --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 43 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin8_prompt_WZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin8_prompt_WZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
if [ ${SLURM_ARRAY_TASK_ID} -eq 44 ]; then
  combine -M MultiDimFit -n _paramFit_Test_prop_binwz-card_bin8_prompt_ZZ --algo impact --redefineSignalPOIs r_prompt_WZ -P prop_binwz-card_bin8_prompt_ZZ --floatOtherPOIs 1 --saveInactivePOI 1 --X-rtd MINIMIZER_MaxCalls=99999999999 --maxFailedSteps 500 --X-rtd MINIMIZER_analytic --setRobustFitTolerance 0.05 --cminPreScan --cminDefaultMinimizerStrategy 0 -m 125 -d wz-ws.root
fi
