...
//=========  (Wed Jul 12 04:36:41 2023) by ROOT version 6.24/07
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-115.3846,-14.07726,525.641,549.0133);
   pad1->SetFillColor(0);
   ...
   m3l_total__1->SetBinContent(3,308.986);
   m3l_total__1->SetBinContent(4,401.4808);
   m3l_total__1->SetBinContent(5,224.7219);
   m3l_total__1->SetBinContent(6,107.6441);
   m3l_total__1->SetBinContent(7,53.03634);
   m3l_total__1->SetBinContent(8,27.48414);
   m3l_total__1->SetBinContent(9,24.14994);
   m3l_total__1->SetBinContent(10,38.57297);
   m3l_total__1->SetBinError(3,10.19072);
   m3l_total__1->SetBinError(4,12.1618);
   m3l_total__1->SetBinError(5,11.1386);
   m3l_total__1->SetBinError(6,7.771357);
   m3l_total__1->SetBinError(7,3.296596);
   m3l_total__1->SetBinError(8,2.378455);
   m3l_total__1->SetBinError(9,2.278634);
   m3l_total__1->SetBinError(10,2.809361);
   m3l_total__1->SetMinimum(0);
   m3l_total__1->SetMaximum(515.2278);
   m3l_total__1->SetEntries(5688);
   ...
   m3l_stack_stack_1->SetMaximum(421.5548);
   ...
   TH1D *m3l_fakes_TT_stack_1 = new TH1D("m3l_fakes_TT_stack_1","dummy",10,0,500);
   m3l_fakes_TT_stack_1->SetBinContent(3,13.40463);
   m3l_fakes_TT_stack_1->SetBinContent(4,18.45394);
   m3l_fakes_TT_stack_1->SetBinContent(5,8.712695);
   m3l_fakes_TT_stack_1->SetBinContent(6,3.891327);
   m3l_fakes_TT_stack_1->SetBinContent(7,1.151938);
   m3l_fakes_TT_stack_1->SetBinContent(8,1.014131);
   m3l_fakes_TT_stack_1->SetBinContent(9,0.5718356);
   m3l_fakes_TT_stack_1->SetBinContent(10,1.153088);
   m3l_fakes_TT_stack_1->SetBinError(3,1.42934);
   m3l_fakes_TT_stack_1->SetBinError(4,1.631254);
   m3l_fakes_TT_stack_1->SetBinError(5,1.142733);
   m3l_fakes_TT_stack_1->SetBinError(6,0.7489599);
   m3l_fakes_TT_stack_1->SetBinError(7,0.4974846);
   m3l_fakes_TT_stack_1->SetBinError(8,0.3833214);
   m3l_fakes_TT_stack_1->SetBinError(9,0.2859297);
   m3l_fakes_TT_stack_1->SetBinError(10,0.4076838);
   m3l_fakes_TT_stack_1->SetEntries(346);

   ci = TColor::GetColor("#666666");
   m3l_fakes_TT_stack_1->SetFillColor(ci);
   m3l_fakes_TT_stack_1->SetMarkerStyle(0);
   m3l_fakes_TT_stack_1->SetMarkerSize(1.1);
   m3l_fakes_TT_stack_1->GetXaxis()->SetTitle("m_{3L} (GeV)");
   m3l_fakes_TT_stack_1->GetXaxis()->SetMoreLogLabels();
   m3l_fakes_TT_stack_1->GetXaxis()->SetLabelFont(42);
   m3l_fakes_TT_stack_1->GetXaxis()->SetLabelOffset(0.007);
   m3l_fakes_TT_stack_1->GetXaxis()->SetLabelSize(0.05);
   m3l_fakes_TT_stack_1->GetXaxis()->SetTitleSize(0.06);
   m3l_fakes_TT_stack_1->GetXaxis()->SetTitleOffset(0.9);
   m3l_fakes_TT_stack_1->GetXaxis()->SetTitleFont(42);
   m3l_fakes_TT_stack_1->GetYaxis()->SetTitle("Events");
   m3l_fakes_TT_stack_1->GetYaxis()->SetLabelFont(42);
   m3l_fakes_TT_stack_1->GetYaxis()->SetLabelOffset(0.007);
   m3l_fakes_TT_stack_1->GetYaxis()->SetLabelSize(0.05);
   m3l_fakes_TT_stack_1->GetYaxis()->SetTitleSize(0.06);
   m3l_fakes_TT_stack_1->GetYaxis()->SetTitleOffset(1.35);
   m3l_fakes_TT_stack_1->GetYaxis()->SetTitleFont(42);
   m3l_fakes_TT_stack_1->GetZaxis()->SetLabelFont(42);
   m3l_fakes_TT_stack_1->GetZaxis()->SetLabelOffset(0.007);
   m3l_fakes_TT_stack_1->GetZaxis()->SetLabelSize(0.05);
   m3l_fakes_TT_stack_1->GetZaxis()->SetTitleSize(0.06);
   m3l_fakes_TT_stack_1->GetZaxis()->SetTitleOffset(1);
   m3l_fakes_TT_stack_1->GetZaxis()->SetTitleFont(42);
   m3l_stack->Add(m3l_fakes_TT_stack_1,"");
   
   TH1D *m3l_fakes_DY_stack_2 = new TH1D("m3l_fakes_DY_stack_2","dummy",10,0,500);
   m3l_fakes_DY_stack_2->SetBinContent(3,11.16278);
   m3l_fakes_DY_stack_2->SetBinContent(4,18.63841);
   m3l_fakes_DY_stack_2->SetBinContent(5,22.31121);
   m3l_fakes_DY_stack_2->SetBinContent(6,11.03804);
   m3l_fakes_DY_stack_2->SetBinError(3,6.444931);
   m3l_fakes_DY_stack_2->SetBinError(4,8.336145);
   m3l_fakes_DY_stack_2->SetBinError(5,9.108761);
   m3l_fakes_DY_stack_2->SetBinError(6,6.374216);
   m3l_fakes_DY_stack_2->SetEntries(21);

   ci = TColor::GetColor("#cccccc");
   m3l_fakes_DY_stack_2->SetFillColor(ci);
   m3l_fakes_DY_stack_2->SetMarkerStyle(0);
   m3l_fakes_DY_stack_2->SetMarkerSize(1.1);
   m3l_fakes_DY_stack_2->GetXaxis()->SetTitle("m_{3L} (GeV)");
   m3l_fakes_DY_stack_2->GetXaxis()->SetMoreLogLabels();
   m3l_fakes_DY_stack_2->GetXaxis()->SetLabelFont(42);
   m3l_fakes_DY_stack_2->GetXaxis()->SetLabelOffset(0.007);
   m3l_fakes_DY_stack_2->GetXaxis()->SetLabelSize(0.05);
   m3l_fakes_DY_stack_2->GetXaxis()->SetTitleSize(0.06);
   m3l_fakes_DY_stack_2->GetXaxis()->SetTitleOffset(0.9);
   m3l_fakes_DY_stack_2->GetXaxis()->SetTitleFont(42);
   m3l_fakes_DY_stack_2->GetYaxis()->SetTitle("Events");
   m3l_fakes_DY_stack_2->GetYaxis()->SetLabelFont(42);
   m3l_fakes_DY_stack_2->GetYaxis()->SetLabelOffset(0.007);
   m3l_fakes_DY_stack_2->GetYaxis()->SetLabelSize(0.05);
   m3l_fakes_DY_stack_2->GetYaxis()->SetTitleSize(0.06);
   m3l_fakes_DY_stack_2->GetYaxis()->SetTitleOffset(1.35);
   m3l_fakes_DY_stack_2->GetYaxis()->SetTitleFont(42);
   m3l_fakes_DY_stack_2->GetZaxis()->SetLabelFont(42);
   m3l_fakes_DY_stack_2->GetZaxis()->SetLabelOffset(0.007);
   m3l_fakes_DY_stack_2->GetZaxis()->SetLabelSize(0.05);
   m3l_fakes_DY_stack_2->GetZaxis()->SetTitleSize(0.06);
   m3l_fakes_DY_stack_2->GetZaxis()->SetTitleOffset(1);
   m3l_fakes_DY_stack_2->GetZaxis()->SetTitleFont(42);
   m3l_stack->Add(m3l_fakes_DY_stack_2,"");
   
   TH1D *m3l_prompt_ZZ_stack_3 = new TH1D("m3l_prompt_ZZ_stack_3","dummy",10,0,500);
   m3l_prompt_ZZ_stack_3->SetBinContent(3,22.97568);
   m3l_prompt_ZZ_stack_3->SetBinContent(4,21.80452);
   m3l_prompt_ZZ_stack_3->SetBinContent(5,9.132709);
   m3l_prompt_ZZ_stack_3->SetBinContent(6,5.165938);
   m3l_prompt_ZZ_stack_3->SetBinContent(7,2.349649);
   m3l_prompt_ZZ_stack_3->SetBinContent(8,1.598166);
   m3l_prompt_ZZ_stack_3->SetBinContent(9,2.392852);
   m3l_prompt_ZZ_stack_3->SetBinContent(10,1.985139);
   m3l_prompt_ZZ_stack_3->SetBinError(3,3.017072);
   m3l_prompt_ZZ_stack_3->SetBinError(4,2.940366);
   m3l_prompt_ZZ_stack_3->SetBinError(5,1.904402);
   m3l_prompt_ZZ_stack_3->SetBinError(6,1.43283);
   m3l_prompt_ZZ_stack_3->SetBinError(7,0.9593805);
   m3l_prompt_ZZ_stack_3->SetBinError(8,0.7991181);
   m3l_prompt_ZZ_stack_3->SetBinError(9,0.97689);
   m3l_prompt_ZZ_stack_3->SetBinError(10,0.8878286);
   m3l_prompt_ZZ_stack_3->SetEntries(174);

   ci = TColor::GetColor("#00cc00");
   m3l_prompt_ZZ_stack_3->SetFillColor(ci);
   m3l_prompt_ZZ_stack_3->SetMarkerStyle(0);
   m3l_prompt_ZZ_stack_3->SetMarkerSize(1.1);
   m3l_prompt_ZZ_stack_3->GetXaxis()->SetTitle("m_{3L} (GeV)");
   m3l_prompt_ZZ_stack_3->GetXaxis()->SetMoreLogLabels();
   m3l_prompt_ZZ_stack_3->GetXaxis()->SetLabelFont(42);
   m3l_prompt_ZZ_stack_3->GetXaxis()->SetLabelOffset(0.007);
   m3l_prompt_ZZ_stack_3->GetXaxis()->SetLabelSize(0.05);
   m3l_prompt_ZZ_stack_3->GetXaxis()->SetTitleSize(0.06);
   m3l_prompt_ZZ_stack_3->GetXaxis()->SetTitleOffset(0.9);
   m3l_prompt_ZZ_stack_3->GetXaxis()->SetTitleFont(42);
   m3l_prompt_ZZ_stack_3->GetYaxis()->SetTitle("Events");
   m3l_prompt_ZZ_stack_3->GetYaxis()->SetLabelFont(42);
   m3l_prompt_ZZ_stack_3->GetYaxis()->SetLabelOffset(0.007);
   m3l_prompt_ZZ_stack_3->GetYaxis()->SetLabelSize(0.05);
   m3l_prompt_ZZ_stack_3->GetYaxis()->SetTitleSize(0.06);
   m3l_prompt_ZZ_stack_3->GetYaxis()->SetTitleOffset(1.35);
   m3l_prompt_ZZ_stack_3->GetYaxis()->SetTitleFont(42);
   m3l_prompt_ZZ_stack_3->GetZaxis()->SetLabelFont(42);
   m3l_prompt_ZZ_stack_3->GetZaxis()->SetLabelOffset(0.007);
   m3l_prompt_ZZ_stack_3->GetZaxis()->SetLabelSize(0.05);
   m3l_prompt_ZZ_stack_3->GetZaxis()->SetTitleSize(0.06);
   m3l_prompt_ZZ_stack_3->GetZaxis()->SetTitleOffset(1);
   m3l_prompt_ZZ_stack_3->GetZaxis()->SetTitleFont(42);
   m3l_stack->Add(m3l_prompt_ZZ_stack_3,"");
   
   TH1D *m3l_prompt_WZ_stack_4 = new TH1D("m3l_prompt_WZ_stack_4","dummy",10,0,500);
   m3l_prompt_WZ_stack_4->SetBinContent(3,261.443);
   m3l_prompt_WZ_stack_4->SetBinContent(4,342.5839);
   m3l_prompt_WZ_stack_4->SetBinContent(5,184.5653);
   m3l_prompt_WZ_stack_4->SetBinContent(6,87.54882);
   m3l_prompt_WZ_stack_4->SetBinContent(7,49.53475);
   m3l_prompt_WZ_stack_4->SetBinContent(8,24.87184);
   m3l_prompt_WZ_stack_4->SetBinContent(9,21.18525);
   m3l_prompt_WZ_stack_4->SetBinContent(10,35.43474);
   m3l_prompt_WZ_stack_4->SetBinError(3,7.15317);
   m3l_prompt_WZ_stack_4->SetBinError(4,8.192148);
   m3l_prompt_WZ_stack_4->SetBinError(5,6.01384);
   m3l_prompt_WZ_stack_4->SetBinError(6,4.141186);
   m3l_prompt_WZ_stack_4->SetBinError(7,3.114425);
   m3l_prompt_WZ_stack_4->SetBinError(8,2.207152);
   m3l_prompt_WZ_stack_4->SetBinError(9,2.038652);
   m3l_prompt_WZ_stack_4->SetBinError(10,2.63402);
   m3l_prompt_WZ_stack_4->SetEntries(5147);

   ci = TColor::GetColor("#ffcc00");
   m3l_prompt_WZ_stack_4->SetFillColor(ci);
   m3l_prompt_WZ_stack_4->SetMarkerStyle(0);
   m3l_prompt_WZ_stack_4->SetMarkerSize(1.1);
   m3l_prompt_WZ_stack_4->GetXaxis()->SetTitle("m_{3L} (GeV)");
   m3l_prompt_WZ_stack_4->GetXaxis()->SetMoreLogLabels();
   m3l_prompt_WZ_stack_4->GetXaxis()->SetLabelFont(42);
   m3l_prompt_WZ_stack_4->GetXaxis()->SetLabelOffset(0.007);
   m3l_prompt_WZ_stack_4->GetXaxis()->SetLabelSize(0.05);
   m3l_prompt_WZ_stack_4->GetXaxis()->SetTitleSize(0.06);
   m3l_prompt_WZ_stack_4->GetXaxis()->SetTitleOffset(0.9);
   m3l_prompt_WZ_stack_4->GetXaxis()->SetTitleFont(42);
   m3l_prompt_WZ_stack_4->GetYaxis()->SetTitle("Events");
   m3l_prompt_WZ_stack_4->GetYaxis()->SetLabelFont(42);
   m3l_prompt_WZ_stack_4->GetYaxis()->SetLabelOffset(0.007);
   m3l_prompt_WZ_stack_4->GetYaxis()->SetLabelSize(0.05);
   m3l_prompt_WZ_stack_4->GetYaxis()->SetTitleSize(0.06);
   m3l_prompt_WZ_stack_4->GetYaxis()->SetTitleOffset(1.35);
   m3l_prompt_WZ_stack_4->GetYaxis()->SetTitleFont(42);
   m3l_prompt_WZ_stack_4->GetZaxis()->SetLabelFont(42);
   m3l_prompt_WZ_stack_4->GetZaxis()->SetLabelOffset(0.007);
   m3l_prompt_WZ_stack_4->GetZaxis()->SetLabelSize(0.05);
   m3l_prompt_WZ_stack_4->GetZaxis()->SetTitleSize(0.06);
   m3l_prompt_WZ_stack_4->GetZaxis()->SetTitleOffset(1);
   m3l_prompt_WZ_stack_4->GetZaxis()->SetTitleFont(42);
   m3l_stack->Add(m3l_prompt_WZ_stack_4,"");
   m3l_stack->Draw("same hist");
   
   TH1D *m3l_total__2 = new TH1D("m3l_total__2","dummy",10,0,500);
   m3l_total__2->SetBinContent(3,308.986);
   m3l_total__2->SetBinContent(4,401.4808);
   m3l_total__2->SetBinContent(5,224.7219);
   m3l_total__2->SetBinContent(6,107.6441);
   m3l_total__2->SetBinContent(7,53.03634);
   m3l_total__2->SetBinContent(8,27.48414);
   m3l_total__2->SetBinContent(9,24.14994);
   m3l_total__2->SetBinContent(10,38.57297);
   m3l_total__2->SetBinError(3,10.19072);
   m3l_total__2->SetBinError(4,12.1618);
   m3l_total__2->SetBinError(5,11.1386);
   m3l_total__2->SetBinError(6,7.771357);
   m3l_total__2->SetBinError(7,3.296596);
   m3l_total__2->SetBinError(8,2.378455);
   m3l_total__2->SetBinError(9,2.278634);
   m3l_total__2->SetBinError(10,2.809361);
   m3l_total__2->SetMinimum(0);
   m3l_total__2->SetMaximum(515.2278);
   m3l_total__2->SetEntries(5688);
   ...
   Graph_m3l_total_errors3001->SetMinimum(21.14341);
   Graph_m3l_total_errors3001->SetMaximum(454.7467);
   ...
   Graph_m3l_data_graph3002->SetMaximum(429.2785);
   ...
   entry=leg->AddEntry("m3l_prompt_WZ_stack_4","WZ","F");
   ...
   entry->SetTextFont(42);
   entry=leg->AddEntry("m3l_prompt_ZZ_stack_3","qqZZ","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("m3l_fakes_DY_stack_2","Fakes DY","F");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("m3l_fakes_TT_stack_1","Fakes TT","F");
...
// ------------>Primitives in pad: pad2
   ...
   Graph_data_div3005->SetMaximum(429.2785);
