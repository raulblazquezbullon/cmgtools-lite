...
//=========  (Sun Feb 19 19:27:33 2023) by ROOT version 6.24/07
   ...
   Graph_m3l_rebin5_total_errors3001->SetMinimum(139.8691);
   Graph_m3l_rebin5_total_errors3001->SetMaximum(1059.255);
