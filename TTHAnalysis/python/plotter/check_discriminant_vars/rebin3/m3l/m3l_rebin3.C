...
//=========  (Tue Apr  4 19:05:08 2023) by ROOT version 6.24/07
   ...
   Graph_m3l_rebin3_total_errors3001->SetMinimum(567.6657);
   Graph_m3l_rebin3_total_errors3001->SetMaximum(1592.039);
