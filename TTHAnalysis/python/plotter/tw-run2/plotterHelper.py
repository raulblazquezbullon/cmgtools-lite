...
chunksizes    = [5000000, 250000, 500000, 250000, 250000]
minchunkbytes = 1000
...
#python mcAnalysis.py --tree NanoAOD -P /pool/ciencias/nanoAODv6/29jan2020_MC/2016/ --Fs ../../macros/temp/2016/0_yeartag --Fs ../../macros/temp/2016/1_lepmerge_roch --Fs ../../macros/temp/2016/2_cleaning --Fs ../../macros/temp/2016/3_varstrigger tw-run2/mca-tw-mc.txt tw-run2/tw_dilepton.txt --uf -l 35.92

#python mcAnalysis.py --tree NanoAOD -P /pool/ciencias/nanoAODv6/29jan2020_MC/2016/ --Fs /pool/phedexrw/userstorage/vrbouza/proyectos/tw_run2/productions/2020-06-01/2016/0_yeartag --Fs /pool/phedexrw/userstorage/vrbouza/proyectos/tw_run2/productions/2020-06-01/2016/1_lepmerge_roch --Fs /pool/phedexrw/userstorage/vrbouza/proyectos/tw_run2/productions/2020-06-01/2016/2_cleaning --Fs /pool/phedexrw/userstorage/vrbouza/proyectos/tw_run2/productions/2020-06-01/2016/3_varstrigger --Fs /pool/phedexrw/userstorage/vrbouza/proyectos/tw_run2/productions/2020-06-01/2016/4_scalefactors tw-run2/mca-tw-2016.txt tw-run2/cuts-tw-2016.txt -l 35.92 -W "MuonSF * ElecSF * TrigSF * puWeight * bTagWeight * PrefireWeight"
...
def getFriendsFolder(dataset, basepath, step_friends):
    ...
    if os.path.isdir(rofolder):
        myfibrefriends = [f for os.listdir(rofolder) if ".root" in f and dataset in f]
