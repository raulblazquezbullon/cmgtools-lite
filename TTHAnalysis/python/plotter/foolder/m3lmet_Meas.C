...
//=========  (Mon Jan 23 11:06:20 2023) by ROOT version 6.24/07
   ...
   TH1D *m3lmet_Meas_total__1 = new TH1D("m3lmet_Meas_total__1","dummy",10,0,500);
   m3lmet_Meas_total__1->SetBinContent(3,19.43511);
   m3lmet_Meas_total__1->SetBinContent(4,431.4962);
   m3lmet_Meas_total__1->SetBinContent(5,998.1993);
   m3lmet_Meas_total__1->SetBinContent(6,779.4889);
   m3lmet_Meas_total__1->SetBinContent(7,453.9378);
   m3lmet_Meas_total__1->SetBinContent(8,263.916);
   m3lmet_Meas_total__1->SetBinContent(9,143.4057);
   m3lmet_Meas_total__1->SetBinContent(10,82.60503);
   m3lmet_Meas_total__1->SetBinContent(11,211.7631);
   m3lmet_Meas_total__1->SetBinError(3,7.830792);
   m3lmet_Meas_total__1->SetBinError(4,21.27724);
   m3lmet_Meas_total__1->SetBinError(5,22.34907);
   m3lmet_Meas_total__1->SetBinError(6,17.96254);
   m3lmet_Meas_total__1->SetBinError(7,12.98762);
   m3lmet_Meas_total__1->SetBinError(8,9.147517);
   m3lmet_Meas_total__1->SetBinError(9,5.551463);
   m3lmet_Meas_total__1->SetBinError(10,4.154464);
   m3lmet_Meas_total__1->SetBinError(11,7.734976);
   m3lmet_Meas_total__1->SetMinimum(0);
   m3lmet_Meas_total__1->SetEntries(15125);
   m3lmet_Meas_total__1->SetDirectory(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#ffcc00");
   m3lmet_Meas_total__1->SetFillColor(ci);
   m3lmet_Meas_total__1->SetMarkerStyle(20);
   m3lmet_Meas_total__1->SetMarkerSize(1.1);
   m3lmet_Meas_total__1->GetXaxis()->SetTitle("m_{WZ} [GeV]");
   m3lmet_Meas_total__1->GetXaxis()->SetMoreLogLabels();
   m3lmet_Meas_total__1->GetXaxis()->SetLabelFont(42);
   m3lmet_Meas_total__1->GetXaxis()->SetLabelOffset(0.007);
   m3lmet_Meas_total__1->GetXaxis()->SetLabelSize(0.05);
   m3lmet_Meas_total__1->GetXaxis()->SetTitleSize(0.05);
   m3lmet_Meas_total__1->GetXaxis()->SetTitleOffset(1.1);
   m3lmet_Meas_total__1->GetXaxis()->SetTitleFont(42);
   m3lmet_Meas_total__1->GetYaxis()->SetTitle("Events/bin");
   m3lmet_Meas_total__1->GetYaxis()->SetLabelFont(42);
   m3lmet_Meas_total__1->GetYaxis()->SetLabelOffset(0.007);
   m3lmet_Meas_total__1->GetYaxis()->SetLabelSize(0.05);
   m3lmet_Meas_total__1->GetYaxis()->SetTitleSize(0.05);
   m3lmet_Meas_total__1->GetYaxis()->SetTitleOffset(2);
   m3lmet_Meas_total__1->GetYaxis()->SetTitleFont(42);
   m3lmet_Meas_total__1->GetZaxis()->SetLabelFont(42);
   m3lmet_Meas_total__1->GetZaxis()->SetLabelOffset(0.007);
   m3lmet_Meas_total__1->GetZaxis()->SetLabelSize(0.05);
   m3lmet_Meas_total__1->GetZaxis()->SetTitleSize(0.06);
   m3lmet_Meas_total__1->GetZaxis()->SetTitleOffset(1);
   m3lmet_Meas_total__1->GetZaxis()->SetTitleFont(42);
   m3lmet_Meas_total__1->Draw("HIST");
   
   THStack *m3lmet_Meas_stack = new THStack();
   m3lmet_Meas_stack->SetName("m3lmet_Meas_stack");
   m3lmet_Meas_stack->SetTitle("m3lmet_Meas");
   
   TH1F *m3lmet_Meas_stack_stack_1 = new TH1F("m3lmet_Meas_stack_stack_1","m3lmet_Meas",10,0,500);
   m3lmet_Meas_stack_stack_1->SetMinimum(0);
   m3lmet_Meas_stack_stack_1->SetMaximum(1048.109);
   m3lmet_Meas_stack_stack_1->SetDirectory(0);
   m3lmet_Meas_stack_stack_1->SetStats(0);
   m3lmet_Meas_stack_stack_1->SetLineStyle(0);
   m3lmet_Meas_stack_stack_1->SetMarkerStyle(20);
   m3lmet_Meas_stack_stack_1->GetXaxis()->SetLabelFont(42);
   m3lmet_Meas_stack_stack_1->GetXaxis()->SetLabelOffset(0.007);
   m3lmet_Meas_stack_stack_1->GetXaxis()->SetLabelSize(0.05);
   m3lmet_Meas_stack_stack_1->GetXaxis()->SetTitleSize(0.06);
   m3lmet_Meas_stack_stack_1->GetXaxis()->SetTitleOffset(0.9);
   m3lmet_Meas_stack_stack_1->GetXaxis()->SetTitleFont(42);
   m3lmet_Meas_stack_stack_1->GetYaxis()->SetLabelFont(42);
   m3lmet_Meas_stack_stack_1->GetYaxis()->SetLabelOffset(0.007);
   m3lmet_Meas_stack_stack_1->GetYaxis()->SetLabelSize(0.05);
   m3lmet_Meas_stack_stack_1->GetYaxis()->SetTitleSize(0.06);
   m3lmet_Meas_stack_stack_1->GetYaxis()->SetTitleOffset(1.35);
   m3lmet_Meas_stack_stack_1->GetYaxis()->SetTitleFont(42);
   m3lmet_Meas_stack_stack_1->GetZaxis()->SetLabelFont(42);
   m3lmet_Meas_stack_stack_1->GetZaxis()->SetLabelOffset(0.007);
   m3lmet_Meas_stack_stack_1->GetZaxis()->SetLabelSize(0.05);
   m3lmet_Meas_stack_stack_1->GetZaxis()->SetTitleSize(0.06);
   m3lmet_Meas_stack_stack_1->GetZaxis()->SetTitleOffset(1);
   m3lmet_Meas_stack_stack_1->GetZaxis()->SetTitleFont(42);
   m3lmet_Meas_stack->SetHistogram(m3lmet_Meas_stack_stack_1);
   ...
   TH1D *m3lmet_Meas_total__2 = new TH1D("m3lmet_Meas_total__2","dummy",10,0,500);
   m3lmet_Meas_total__2->SetBinContent(3,19.43511);
   m3lmet_Meas_total__2->SetBinContent(4,431.4962);
   m3lmet_Meas_total__2->SetBinContent(5,998.1993);
   m3lmet_Meas_total__2->SetBinContent(6,779.4889);
   m3lmet_Meas_total__2->SetBinContent(7,453.9378);
   m3lmet_Meas_total__2->SetBinContent(8,263.916);
   m3lmet_Meas_total__2->SetBinContent(9,143.4057);
   m3lmet_Meas_total__2->SetBinContent(10,82.60503);
   m3lmet_Meas_total__2->SetBinContent(11,211.7631);
   m3lmet_Meas_total__2->SetBinError(3,7.830792);
   m3lmet_Meas_total__2->SetBinError(4,21.27724);
   m3lmet_Meas_total__2->SetBinError(5,22.34907);
   m3lmet_Meas_total__2->SetBinError(6,17.96254);
   m3lmet_Meas_total__2->SetBinError(7,12.98762);
   m3lmet_Meas_total__2->SetBinError(8,9.147517);
   m3lmet_Meas_total__2->SetBinError(9,5.551463);
   m3lmet_Meas_total__2->SetBinError(10,4.154464);
   m3lmet_Meas_total__2->SetBinError(11,7.734976);
   m3lmet_Meas_total__2->SetMinimum(0);
   m3lmet_Meas_total__2->SetEntries(15125);
   m3lmet_Meas_total__2->SetDirectory(0);

   ci = TColor::GetColor("#ffcc00");
   m3lmet_Meas_total__2->SetFillColor(ci);
   m3lmet_Meas_total__2->SetMarkerStyle(20);
   m3lmet_Meas_total__2->SetMarkerSize(1.1);
   m3lmet_Meas_total__2->GetXaxis()->SetTitle("m_{WZ} [GeV]");
   m3lmet_Meas_total__2->GetXaxis()->SetMoreLogLabels();
   m3lmet_Meas_total__2->GetXaxis()->SetLabelFont(42);
   m3lmet_Meas_total__2->GetXaxis()->SetLabelOffset(0.007);
   m3lmet_Meas_total__2->GetXaxis()->SetLabelSize(0.05);
   m3lmet_Meas_total__2->GetXaxis()->SetTitleSize(0.05);
   m3lmet_Meas_total__2->GetXaxis()->SetTitleOffset(1.1);
   m3lmet_Meas_total__2->GetXaxis()->SetTitleFont(42);
   m3lmet_Meas_total__2->GetYaxis()->SetTitle("Events/bin");
   m3lmet_Meas_total__2->GetYaxis()->SetLabelFont(42);
   m3lmet_Meas_total__2->GetYaxis()->SetLabelOffset(0.007);
   m3lmet_Meas_total__2->GetYaxis()->SetLabelSize(0.05);
   m3lmet_Meas_total__2->GetYaxis()->SetTitleSize(0.05);
   m3lmet_Meas_total__2->GetYaxis()->SetTitleOffset(2);
   m3lmet_Meas_total__2->GetYaxis()->SetTitleFont(42);
   m3lmet_Meas_total__2->GetZaxis()->SetLabelFont(42);
   m3lmet_Meas_total__2->GetZaxis()->SetLabelOffset(0.007);
   m3lmet_Meas_total__2->GetZaxis()->SetLabelSize(0.05);
   m3lmet_Meas_total__2->GetZaxis()->SetTitleSize(0.06);
   m3lmet_Meas_total__2->GetZaxis()->SetTitleOffset(1);
   m3lmet_Meas_total__2->GetZaxis()->SetTitleFont(42);
   m3lmet_Meas_total__2->Draw("AXIS SAME");
   
   Double_t m3lmet_Meas_total_errors_fx3001[8] = {
   125,
   175,
   225,
   275,
   ...
   425,
   475};
   Double_t m3lmet_Meas_total_errors_fy3001[8] = {
   19.43511,
   431.4962,
   998.1993,
   779.4889,
   ...
   143.4057,
   82.60503};
   Double_t m3lmet_Meas_total_errors_felx3001[8] = {
   25,
   25,
   25,
   25,
   ...
   25,
   25};
   Double_t m3lmet_Meas_total_errors_fely3001[8] = {
   7.133332,
   39.55973,
   68.05557,
   64.95798,
   ...
   12.16724,
   6.097637};
   Double_t m3lmet_Meas_total_errors_fehx3001[8] = {
   25,
   25,
   25,
   25,
   ...
   25,
   25};
   Double_t m3lmet_Meas_total_errors_fehy3001[8] = {
   16.65968,
   29.20447,
   72.28378,
   61.56805,
   ...
   10.93532,
   7.820701};
   TGraphAsymmErrors *grae = new TGraphAsymmErrors(8,m3lmet_Meas_total_errors_fx3001,m3lmet_Meas_total_errors_fy3001,m3lmet_Meas_total_errors_felx3001,m3lmet_Meas_total_errors_fehx3001,m3lmet_Meas_total_errors_fely3001,m3lmet_Meas_total_errors_fehy3001);
   ...
   TH1F *Graph_m3lmet_Meas_total_errors3001 = new TH1F("Graph_m3lmet_Meas_total_errors3001","Graph",100,60,540);
   Graph_m3lmet_Meas_total_errors3001->SetMinimum(11.0716);
   Graph_m3lmet_Meas_total_errors3001->SetMaximum(1176.301);
   Graph_m3lmet_Meas_total_errors3001->SetDirectory(0);
   Graph_m3lmet_Meas_total_errors3001->SetStats(0);
   Graph_m3lmet_Meas_total_errors3001->SetLineStyle(0);
   Graph_m3lmet_Meas_total_errors3001->SetMarkerStyle(20);
   Graph_m3lmet_Meas_total_errors3001->GetXaxis()->SetLabelFont(42);
   Graph_m3lmet_Meas_total_errors3001->GetXaxis()->SetLabelOffset(0.007);
   Graph_m3lmet_Meas_total_errors3001->GetXaxis()->SetLabelSize(0.05);
   Graph_m3lmet_Meas_total_errors3001->GetXaxis()->SetTitleSize(0.06);
   Graph_m3lmet_Meas_total_errors3001->GetXaxis()->SetTitleOffset(0.9);
   Graph_m3lmet_Meas_total_errors3001->GetXaxis()->SetTitleFont(42);
   Graph_m3lmet_Meas_total_errors3001->GetYaxis()->SetLabelFont(42);
   Graph_m3lmet_Meas_total_errors3001->GetYaxis()->SetLabelOffset(0.007);
   Graph_m3lmet_Meas_total_errors3001->GetYaxis()->SetLabelSize(0.05);
   Graph_m3lmet_Meas_total_errors3001->GetYaxis()->SetTitleSize(0.06);
   Graph_m3lmet_Meas_total_errors3001->GetYaxis()->SetTitleOffset(1.35);
   Graph_m3lmet_Meas_total_errors3001->GetYaxis()->SetTitleFont(42);
   Graph_m3lmet_Meas_total_errors3001->GetZaxis()->SetLabelFont(42);
   Graph_m3lmet_Meas_total_errors3001->GetZaxis()->SetLabelOffset(0.007);
   Graph_m3lmet_Meas_total_errors3001->GetZaxis()->SetLabelSize(0.05);
   Graph_m3lmet_Meas_total_errors3001->GetZaxis()->SetTitleSize(0.06);
   Graph_m3lmet_Meas_total_errors3001->GetZaxis()->SetTitleOffset(1);
   Graph_m3lmet_Meas_total_errors3001->GetZaxis()->SetTitleFont(42);
   grae->SetHistogram(Graph_m3lmet_Meas_total_errors3001);
