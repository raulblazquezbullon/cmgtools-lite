...
float getElSF_v4_2016(int wp, int unc, float pt, float eta){
  ...
  float sfLtoT     =  1;//getSF(h_elSF_v4_2016_LtoT_mva, abs(eta), pt);
  float sfLtoTstat =  0;//getSF(h_elSF_v4_2016_LtoT_mva_stat, pt, abs(eta));
  float sfLtoTsyst =  0;//getSF(h_elSF_v4_2016_LtoT_mva_syst, pt, abs(eta));
  ...
  return sfTtoL*sfLtoL; //sfLtoT*(1+uncst*sfLtoTstat + uncsy*sfLtoTsyst);
}
...
float getElSF_v4_2017(int wp, int unc, float pt, float eta){
  ...
  //And then loose leptonMVA to tight leptonMVA
  float sfLtoT     =  1;//getSF(h_elSF_v4_2017_LtoT_mva, abs(eta), pt);
  float sfLtoTstat =  0;//getSF(h_elSF_v4_2017_LtoT_mva_stat, pt, abs(eta));
  float sfLtoTsyst =  0;//getSF(h_elSF_v4_2017_LtoT_mva_syst, pt, abs(eta));
...
float getElSF_v4_2018(int wp, int unc, float pt, float eta){
  ...
  //And then loose leptonMVA to tight leptonMVA
  float sfLtoT     =  1;//getSF(h_elSF_v4_2018_LtoT_mva, abs(eta), pt);
  float sfLtoTstat =  0;//getSF(h_elSF_v4_2018_LtoT_mva_stat, pt, abs(eta));
  float sfLtoTsyst =  0;//getSF(h_elSF_v4_2018_LtoT_mva_syst, pt, abs(eta));
  //return sfLtoL*sfLtoT*(1 + uncr*sfLtoLcorr)*(1 + uncst*sfLtoTstat + uncsy*sfLtoTsyst);
  return sfLtoL;//sfLtoT*(1+uncst*sfLtoTstat + uncsy*sfLtoTsyst);
}
...
float getMuSF_v4_2016(int wp, int unc, float pt, float eta){
  ...
  //And then loose leptonMVA to tight leptonMVA
  float sfLtoT     = 1;//getSF(h_muSF_v4_2016_LtoT_mva, abs(eta),  pt);
  float sfLtoTstat = 0;//getSF(h_muSF_v4_2016_LtoT_mva_stat, pt, abs(eta));
  float sfLtoTsyst = 0;//getSF(h_muSF_v4_2016_LtoT_mva_syst, pt, abs(eta));
...
float getMuSF_v4_2017(int wp, int unc, float pt, float eta){
  ...
  //TODO: Add LtoL lepton uncertainty
  //And then loose leptonMVA to tight leptonMVA
  float sfLtoT     =  1;//getSF(h_muSF_v4_2017_LtoT_mva, abs(eta),  pt);
  float sfLtoTstat =  0;//getSF(h_muSF_v4_2017_LtoT_mva_stat, pt, abs(eta));
  float sfLtoTsyst =  0;//getSF(h_muSF_v4_2017_LtoT_mva_syst, pt, abs(eta));
...
float getMuSF_v4_2018(int wp, int unc, float pt, float eta){
  ...
  //TODO: Add LtoL lepton uncertainty
  //And then loose leptonMVA to tight leptonMVA
  float sfLtoT     =  1; //getSF(h_muSF_v4_2018_LtoT_mva, abs(eta), pt);
  float sfLtoTstat =  0; //getSF(h_muSF_v4_2018_LtoT_mva_stat, pt, abs(eta));
  float sfLtoTsyst =  0; //getSF(h_muSF_v4_2018_LtoT_mva_syst, pt, abs(eta));
