...
class coeffs(object):
    ...
    def doControl(self):
        ...
        theL = ROOT.TLegend(0.4, 0.55, 0.85, 0.9)
        theL.AddEntry(self.histoc, "Generated", "L")
        theL.AddEntry(self.quadF, "Fit, P-value = %1.3f"%(self.prob), "L")
        ...
        self.fR.Draw("same")
        theL.Draw("same")
        c.SaveAs("/nfs/fanae/user/carlosec/www/wz/Legacy/polPlots/"+self.tag + ".pdf")
        c.SaveAs("/nfs/fanae/user/carlosec/www/wz/Legacy/polPlots/"+self.tag + ".png")
        c.SaveAs("/nfs/fanae/user/carlosec/www/wz/Legacy/polPlots/"+self.tag + ".root")
