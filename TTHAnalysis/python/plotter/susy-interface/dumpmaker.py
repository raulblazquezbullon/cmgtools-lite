...
for r in range(len(mm.regions)):
	...
	for p in procs:
		...
		mm.submit([mm.getVariable("mcafile",""), mm.getVariable("cutfile",""), fmt, mm.treedir, mm.getVariable("treename","treeProducerSusyMultilepton"), mccs, macros, friends, "-p "+p, flags, output, tag],mm.region.name,False)
