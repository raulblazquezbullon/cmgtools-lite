...
O="/afs/cern.ch/user/c/cheidegg/www/heppy/2017-01-09_ewk80X_unblinded" # Do NOT give a trailing /
L=36.5
#L=17.3
FL=36.5
QUEUE="" #"-q all.q"
...
## data fakes
#python susy-interface/plotmaker.py 3l "3lA;3lB;3lC;3lD;3lE;3lF;4lG;4lH;4lI;4lJ;4lK" $T $O -l $L  --make data --plots perCateg -o SR   --flags "--perBin $BLIND" $QUEUE
python susy-interface/plotmaker.py 3l "3lA;3lB;3lC;3lD;3lE;3lF;4lG;4lH;4lI;4lJ;4lK" $T $O -l $L  --make data --plots evt      -o SR   --flags "--perBin $BLIND" $QUEUE
python susy-interface/plotmaker.py 3l "3lA;3lB;3lC;3lD;3lE;3lF;4lG;4lH;4lI;4lJ;4lK" $T $O -l $L  --make data --plots lep      -o SR   --flags "--perBin $BLIND" $QUEUE

## MC fakes
python susy-interface/plotmaker.py 3l "3lA;3lB;3lC;3lD;3lE;3lF;4lG;4lH;4lI;4lJ;4lK" $T $O -l $L  --make data --plots perCateg -o SRmc --flags "--perBin $BLIND" $QUEUE -p "fakes_matched;prompt_.*;rares_.*;convs;data" 
python susy-interface/plotmaker.py 3l "3lA;3lB;3lC;3lD;3lE;3lF;4lG;4lH;4lI;4lJ;4lK" $T $O -l $L  --make data --plots evt      -o SRmc --flags "--perBin $BLIND" $QUEUE -p "fakes_matched;prompt_.*;rares_.*;convs;data" 
python susy-interface/plotmaker.py 3l "3lA;3lB;3lC;3lD;3lE;3lF;4lG;4lH;4lI;4lJ;4lK" $T $O -l $L  --make data --plots lep      -o SRmc --flags "--perBin $BLIND" $QUEUE -p "fakes_matched;prompt_.*;rares_.*;convs;data" 
...
#
## data fakes
#python susy-interface/plotmaker.py 3l "3lA;3lB;3lC;3lD;3lE;3lF;4lG;4lH;4lI;4lJ;4lK" $T $O -l $L --make data --plots perCateg -o SR   --flags "--perBin $BLIND" $QUEUE --plot susy-ewkino/3l/plots_ewkino_nolog.txt
python susy-interface/plotmaker.py 3l "3lA;3lB;3lC;3lD;3lE;3lF;4lG;4lH;4lI;4lJ;4lK" $T $O -l $L --make data --plots evt      -o SR   --flags "--perBin $BLIND" $QUEUE --plot susy-ewkino/3l/plots_ewkino_nolog.txt
python susy-interface/plotmaker.py 3l "3lA;3lB;3lC;3lD;3lE;3lF;4lG;4lH;4lI;4lJ;4lK" $T $O -l $L --make data --plots lep      -o SR   --flags "--perBin $BLIND" $QUEUE --plot susy-ewkino/3l/plots_ewkino_nolog.txt

## MC fakes
python susy-interface/plotmaker.py 3l "3lA;3lB;3lC;3lD;3lE;3lF;4lG;4lH;4lI;4lJ;4lK" $T $O -l $L --make data --plots perCateg -o SRmc --flags "--perBin $BLIND" $QUEUE -p "fakes_matched;prompt_.*;rares_.*;convs;data" --plot susy-ewkino/3l/plots_ewkino_nolog.txt
python susy-interface/plotmaker.py 3l "3lA;3lB;3lC;3lD;3lE;3lF;4lG;4lH;4lI;4lJ;4lK" $T $O -l $L --make data --plots evt      -o SRmc --flags "--perBin $BLIND" $QUEUE -p "fakes_matched;prompt_.*;rares_.*;convs;data" --plot susy-ewkino/3l/plots_ewkino_nolog.txt
python susy-interface/plotmaker.py 3l "3lA;3lB;3lC;3lD;3lE;3lF;4lG;4lH;4lI;4lJ;4lK" $T $O -l $L --make data --plots lep      -o SRmc --flags "--perBin $BLIND" $QUEUE -p "fakes_matched;prompt_.*;rares_.*;convs;data" --plot susy-ewkino/3l/plots_ewkino_nolog.txt
