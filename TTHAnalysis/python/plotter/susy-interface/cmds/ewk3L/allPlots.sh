...
## event quantities
#python susy-interface/plotmaker.py 3l 3lA $T $O -l 35 --make mix --plots evt -o SR --flags '-X blinding --perBin --plotgroup fakes_matched_DY+=fakes_matched_WW --plotgroup fakes_matched_DY+=fakes_matched_WJ --plotgroup fakes_matched_DY+=fakes_matched_TT --plotgroup fakes_matched_DY+=fakes_matched_ST' -p "fakes_matched_.*;prompt_.*;rares_.*;convs" -p "sig_TChiNeuWZ_200_100;sig_TChiNeuWZ_400_1" $QUEUE
python susy-interface/plotmaker.py 3l "3lC;3lD;3lE;3lF" $T $O -l 35 --make mix --selPlots "met" -o SR --flags '-X blinding --perBin --plotgroup fakes_matched_DY+=fakes_matched_WW --plotgroup fakes_matched_DY+=fakes_matched_WJ --plotgroup fakes_matched_DY+=fakes_matched_TT --plotgroup fakes_matched_DY+=fakes_matched_ST' -p "fakes_matched_.*;prompt_.*;rares_.*;convs" -p "sig_TChiNeuSlepSneuTD_700_1" $QUEUE
#python susy-interface/plotmaker.py 3l "3lC;3lD;3lE;3lF" $T $O -l 35 --make mix --selPlots "mtW3l;mT2L3l;mT2T3l" -o SR --flags '-X blinding --perBin --plotgroup fakes_matched_DY+=fakes_matched_WW --plotgroup fakes_matched_DY+=fakes_matched_WJ --plotgroup fakes_matched_DY+=fakes_matched_TT --plotgroup fakes_matched_DY+=fakes_matched_ST' -p "fakes_matched_.*;prompt_.*;rares_.*;convs" -p "sig_TChiNeuSlepSneuTD_700_1" $QUEUE
