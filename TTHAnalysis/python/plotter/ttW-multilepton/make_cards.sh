...
SYSTS="ttW-multilepton/systsEnv.txt"
BLoose=" -E ^BLoose "
BTight=" -E ^BTight "
...
OPTIONS="${OPTIONS} -L ttW-multilepton/functionsTTH.cc --mcc ttW-multilepton/lepchoice-ttH-FO.txt ${PROMPTSUB} --neg" # neg necessary for subsequent rebin
CATPOSTFIX=""
...
if [[ "$1" == "all" || "$1" == "2lss" || "$1" == "2lss_3j" ]]; then
	...
	FLAV=" -E ^${X} "
	if [[ "${X}" == "ee" ]]; then
	    python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_2L} ttW-multilepton/mca-2lss-${MCASUFFIX}${SPLITDECAYS}.txt ttW-multilepton/2lss_tight.txt ${FUNCTION_2L} $SYSTS $OPT_2L -o 2lss_${X}_pos${CATPOSTFIX} $POS $FLAV;
            python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_2L} ttW-multilepton/mca-2lss-${MCASUFFIX}${SPLITDECAYS}.txt ttW-multilepton/2lss_tight.txt ${FUNCTION_2L} $SYSTS $OPT_2L -o 2lss_${X}_neg${CATPOSTFIX} $NEG $FLAV;
	else
	    python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_2L} ttW-multilepton/mca-2lss-${MCASUFFIX}${SPLITDECAYS}.txt ttW-multilepton/2lss_tight.txt ${FUNCTION_2L} $SYSTS $OPT_2L -o 2lss_${X}_bl_pos${CATPOSTFIX} $POS $BLoose $FLAV;
            python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_2L} ttW-multilepton/mca-2lss-${MCASUFFIX}${SPLITDECAYS}.txt ttW-multilepton/2lss_tight.txt ${FUNCTION_2L} $SYSTS $OPT_2L -o 2lss_${X}_bl_neg${CATPOSTFIX} $NEG $BLoose $FLAV;
            python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_2L} ttW-multilepton/mca-2lss-${MCASUFFIX}${SPLITDECAYS}.txt ttW-multilepton/2lss_tight.txt ${FUNCTION_2L} $SYSTS $OPT_2L -o 2lss_${X}_bt_pos${CATPOSTFIX} $POS $BTight $FLAV;
            python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_2L} ttW-multilepton/mca-2lss-${MCASUFFIX}${SPLITDECAYS}.txt ttW-multilepton/2lss_tight.txt ${FUNCTION_2L} $SYSTS $OPT_2L -o 2lss_${X}_bt_neg${CATPOSTFIX} $NEG $BTight $FLAV;
	fi
    done
...
if [[ "$1" == "all" || "$1" == "3l" ]]; then
    ...
    echo "3l";
    python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_3L} ttW-multilepton/mca-3l-${MCASUFFIX}${SPLITDECAYS}.txt ttW-multilepton/3l_tight.txt ${FUNCTION_3L} $SYSTS $OPT_3L -o 3l_bl_pos${CATPOSTFIX} $POS $BLoose;
    python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_3L} ttW-multilepton/mca-3l-${MCASUFFIX}${SPLITDECAYS}.txt ttW-multilepton/3l_tight.txt ${FUNCTION_3L} $SYSTS $OPT_3L -o 3l_bl_neg${CATPOSTFIX} $NEG $BLoose;
    python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_3L} ttW-multilepton/mca-3l-${MCASUFFIX}${SPLITDECAYS}.txt ttW-multilepton/3l_tight.txt ${FUNCTION_3L} $SYSTS $OPT_3L -o 3l_bt_pos${CATPOSTFIX} $POS $BTight;
    python makeShapeCards.py ${DOFILE} --2d-binning-function ${BINFUNCTION_3L} ttW-multilepton/mca-3l-${MCASUFFIX}${SPLITDECAYS}.txt ttW-multilepton/3l_tight.txt ${FUNCTION_3L} $SYSTS $OPT_3L -o 3l_bt_neg${CATPOSTFIX} $NEG $BTight;
...
if [[ "$1" == "all" || "$1" == "4l" ]]; then
    ...
    echo "4l";
    python makeShapeCards.py ${DOFILE} ttW-multilepton/mca-4l-${MCASUFFIX}${SPLITDECAYS}.txt ttW-multilepton/4l_tight.txt ${ONEBIN_4L} $SYSTS $OPT_4L -o 4l${CATPOSTFIX};
