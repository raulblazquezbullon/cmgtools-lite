...
elif 'fanae' in os.environ['HOSTNAME']:       ORIGIN="/pool/phedex/"; 
elif 'gae' in os.environ['HOSTNAME']:       ORIGIN="/pool/phedex/"; 
...
OPTIONS="{OPTIONS} --od {OUTNAME} ".format(OPTIONS=OPTIONS, OUTNAME=OUTNAME)
...
T2L="-P {ORIGIN}/TOPnanoAODv6/ttW_MC_Ntuples_skim/{YEAR} -P {ORIGIN}/TOPnanoAODv6/ttW_DATA_Ntuples_skim/{YEAR} --FMCs {{P}}/0_jmeUnc_v1 --FDs {{P}}/1_recl_enero --FMCs {{P}}/1_recl_allvars --FMCs {{P}}/2_btag_SFs_fix11m --FMCs {{P}}/2_scalefactors_triglep --Fs {{P}}/3_tauCount --Fs {{P}}/4_evtVars --xf TTTW --xf TTWH".format(ORIGIN=ORIGIN, YEAR=YEAR)
T3L=T2L
T4L=T2L

SYSTS="--unc ttW-multilepton/systsUnc.txt --amc --xu CMS_ttHl_TTZ_lnU,CMS_ttHl_TTW_lnU"
MCAOPTION=""
...
if "scan" in OTHER:         
    ...
    MCAOPTION="-ctcv"
    SYSTS="--unc ttW-multilepton/systsUnc.txt --amc"

if 'unblind' in OTHER:
    ASIMOV=""

print("We are using the asimov dataset")
OPTIONS="{OPTIONS} -L ttW-multilepton/functionsTTH.cc --mcc ttW-multilepton/lepchoice-ttH-FO.txt --mcc ttW-multilepton/mcc-METFixEE2017.txt {PROMPTSUB} --neg   --threshold 0.01 {ASIMOV} --filter ttW-multilepton/filter-processes.txt ".format(OPTIONS=OPTIONS,PROMPTSUB=PROMPTSUB,ASIMOV=ASIMOV) # neg necessary for subsequent rebin #  
CATPOSTFIX=""
...
FUNCTION_SVA_3l_ttW =  '''"LepGood1_pt+LepGood2_pt+LepGood3_pt" 50,50,400'''
...
if REGION == "2lss":
    ...
    TORUN='''python {SCRIPT} {DOFILE} ttW-multilepton/mca-2lss-{MCASUFFIX}{MCAOPTION}.txt ttW-multilepton/2lss_tight_legacy.txt "{FUNCTION_2L}" "{CATBINS}" {SYSTS} {OPT_2L} --binname ttH_2lss_0tau --year {YEAR} --categorize-by-ranges {RANGES} {NAMES} '''.format(SCRIPT=SCRIPT, DOFILE=DOFILE, MCASUFFIX=MCASUFFIX, MCAOPTION=MCAOPTION, FUNCTION_2L=FUNCTION_2L, CATBINS=CATBINS, SYSTS=SYSTS, OPT_2L=OPT_2L,YEAR=YEAR,RANGES=RANGES,NAMES=NAMES)
...
if REGION == "2lss_SVA":
    ...
    OPT_2L='{T2L} {OPTIONS} -W "L1PreFiringWeight_Nom*puWeight*btagSF_shape*leptonSF_2lss*triggerSF_ttH(LepGood1_pdgId, LepGood1_conePt, LepGood2_pdgId, LepGood2_conePt, 2, year)"'.format(T2L=T2L, OPTIONS=OPTIONS)
    CATPOSTFIX=""
    TORUN='''python {SCRIPT} {DOFILE} ttW-multilepton/mca-2lss-{MCASUFFIX}{MCAOPTION}.txt ttW-multilepton/2lss_tight.txt {FUNCTION_SVA_2L} {SYSTS} {OPT_2L} --binname ttH_2lss_{YEAR} --categorize {CATFUNC} {CATBINS} {CATNAMES}  --year {YEAR};'''.format(SCRIPT=SCRIPT, DOFILE=DOFILE, MCASUFFIX=MCASUFFIX, MCAOPTION=MCAOPTION, FUNCTION_SVA_2L=FUNCTION_SVA_2L, SYSTS=SYSTS, OPT_2L=OPT_2L, CATFUNC=CATFUNC,CATNAMES=CATNAMES, CATBINS=CATBINS,YEAR=YEAR)
    print(submit.format(command=TORUN))
...
if REGION == "2lss_SVA_scan":
    ...
    CATPOSTFIX=""
    TORUN1='''python {SCRIPT} {DOFILE} ttW-multilepton/mca-2lss-{MCASUFFIX}{MCAOPTION}.txt ttW-multilepton/2lss_tight_thq.txt {FUNCTION_SVA_2L} {SYSTS} {OPT_2L} --binname ttH_2lss_{YEAR} -E ^tthlike -X ^borthogonality -X ^FRWorthogonality --categorize {CATFUNC} {CATBINS} {CATNAMES}  --year {YEAR};'''.format(SCRIPT=SCRIPT, DOFILE=DOFILE, MCASUFFIX=MCASUFFIX, MCAOPTION=MCAOPTION, FUNCTION_SVA_2L=FUNCTION_SVA_2L_scan, SYSTS=SYSTS, OPT_2L=OPT_2L, CATFUNC=CATFUNC,CATNAMES=CATNAMES, CATBINS=CATBINS,YEAR=YEAR)
    TORUN2='''python {SCRIPT} {DOFILE} ttW-multilepton/mca-2lss-{MCASUFFIX}{MCAOPTION}.txt ttW-multilepton/2lss_tight_thq.txt {FUNCTION_SVA_2L} {SYSTS} {OPT_2L} --binname tHq_2lss_{YEAR} -E ^thqlike -X ^borthogonality -X ^FRWorthogonality --categorize {CATFUNC} {CATBINS} {CATNAMES}  --year {YEAR};'''.format(SCRIPT=SCRIPT, DOFILE=DOFILE, MCASUFFIX=MCASUFFIX, MCAOPTION=MCAOPTION, FUNCTION_SVA_2L=FUNCTION_SVA_2L_scan, SYSTS=SYSTS, OPT_2L=OPT_2L, CATFUNC=CATFUNC,CATNAMES=CATNAMES, CATBINS=CATBINS,YEAR=YEAR)
...
if REGION == "2lss_3j_SVA":
    ...
    CATPOSTFIX=""
    TORUN='''python {SCRIPT} {DOFILE} ttW-multilepton/mca-2lss-{MCASUFFIX}{MCAOPTION}.txt ttW-multilepton/2lss_tight.txt {FUNCTION_SVA_2L} {SYSTS} {OPT_2L} --binname ttH_2lss_3j_{YEAR} --categorize {CATFUNC} {CATBINS} {CATNAMES}  --year {YEAR};'''.format(SCRIPT=SCRIPT, DOFILE=DOFILE, MCASUFFIX=MCASUFFIX, MCAOPTION=MCAOPTION, FUNCTION_SVA_2L=FUNCTION_SVA_2L, SYSTS=SYSTS, OPT_2L=OPT_2L, CATFUNC=CATFUNC,CATNAMES=CATNAMES, CATBINS=CATBINS,YEAR=YEAR)
    print(submit.format(command=TORUN))
...
if REGION == "3l":
    ...
    TORUN = 'python {SCRIPT} {DOFILE} ttW-multilepton/mca-3l-{MCASUFFIX}{MCAOPTION}.txt ttW-multilepton/3l_tight_legacy.txt "{FUNCTION_3L}" "{CATBINS}" {SYSTS} {OPT_3L} --binname ttH_3l_0tau --year {YEAR} --categorize-by-ranges {RANGES} {NAMES}'.format(SCRIPT=SCRIPT, DOFILE=DOFILE,MCASUFFIX=MCASUFFIX,MCAOPTION=MCAOPTION,FUNCTION_3L=FUNCTION_3L,CATBINS=CATBINS,YEAR=YEAR, SYSTS=SYSTS, OPT_3L=OPT_3L,RANGES=RANGES, NAMES=NAMES)
    print(submit.format(command=TORUN))
...
if REGION == "3l_SVA":
    ...
    OPT_3L='{T3L} {OPTIONS} -W "L1PreFiringWeight_Nom*puWeight*btagSF_shape*triggerSF_ttH(LepGood1_pdgId, LepGood1_conePt, LepGood2_pdgId, LepGood2_conePt, 3, year)*leptonSF_3l"'.format(T3L=T3L, OPTIONS=OPTIONS)
    TORUN="python {SCRIPT} {DOFILE} ttW-multilepton/mca-3l-{MCASUFFIX}{MCAOPTION}.txt ttW-multilepton/3l_tight.txt {FUNCTION_SVA_3L} {SYSTS} {OPT_3L} --binname ttH_3l_{YEAR} --categorize {CATFUNC} {CATBINS} {CATNAMES}  --year {YEAR} ;".format(SCRIPT=SCRIPT,DOFILE=DOFILE,MCASUFFIX=MCASUFFIX,MCAOPTION=MCAOPTION,FUNCTION_SVA_3L=FUNCTION_SVA_3L,SYSTS=SYSTS,OPT_3L=OPT_3L,CATFUNC=CATFUNC,CATBINS=CATBINS,CATNAMES=CATNAMES,YEAR=YEAR)
    print(submit.format(command=TORUN))

if REGION == "3l_SVA_ttW":
    CATFUNC='''"ttW_3l_SVA_classifier( nJet25,nBJetMedium25, LepGood1_charge, LepGood2_charge,  LepGood3_charge)"'''
    CATBINS="[0.5,1.5,2.5,3.5,4.5,6.5,7.5,8.5,9.5,10.5,11.5,12.5]"
    CATNAMES="2j1b_neg,2j1b_pos,2j2b_neg,2j2b_pos,3j1b_neg,3j1b_pos,3j2b_neg,3j2b_pos,gt3j1b_neg,gt3j1b_pos,gt3j2b_neg,gt3j2b_pos"
    OPT_3L="{T3L} {OPTIONS} -W L1PreFiringWeight_Nom*puWeight*btagSF_shape*triggerSF_3l*leptonSF_3l".format(T3L=T3L, OPTIONS=OPTIONS)
    TORUN1='''python {SCRIPT} {DOFILE} ttW-multilepton/mca-3l-{MCASUFFIX}{MCAOPTION}.txt ttW-multilepton/3l_tight.txt {FUNCTION_SVA_3L} {SYSTS} {OPT_3L} --binname ttH_3l_{YEAR} --categorize {CATFUNC} {CATBINS} {CATNAMES}  --year {YEAR};'''.format(SCRIPT=SCRIPT, DOFILE=DOFILE, MCASUFFIX=MCASUFFIX, MCAOPTION=MCAOPTION, FUNCTION_SVA_3L=FUNCTION_SVA_3l_ttW, SYSTS=SYSTS, OPT_3L=OPT_3L, CATFUNC=CATFUNC,CATNAMES=CATNAMES, CATBINS=CATBINS,YEAR=YEAR)
    print(submit.format(command=TORUN1))
...
if REGION == "3l_SVA_scan":
    ...
    CATNAMES="lj_neg,lj_pos,hj_neg,hj_pos"
    OPT_3L="{T3L} {OPTIONS} -W L1PreFiringWeight_Nom*puWeight*btagSF_shape*triggerSF_3l*leptonSF_3l".format(T3L=T3L, OPTIONS=OPTIONS)
    TORUN1='''python {SCRIPT} {DOFILE} ttW-multilepton/mca-3l-{MCASUFFIX}{MCAOPTION}.txt ttW-multilepton/3l_tight_thq.txt {FUNCTION_SVA_3L} {SYSTS} {OPT_3L} --binname ttH_3l_{YEAR} -E ^tthlike -X ^borthogonality -X ^FRWorthogonality --categorize {CATFUNC} {CATBINS} {CATNAMES}  --year {YEAR};'''.format(SCRIPT=SCRIPT, DOFILE=DOFILE, MCASUFFIX=MCASUFFIX, MCAOPTION=MCAOPTION, FUNCTION_SVA_3L=FUNCTION_SVA_2L_scan, SYSTS=SYSTS, OPT_3L=OPT_3L, CATFUNC=CATFUNC,CATNAMES=CATNAMES, CATBINS=CATBINS,YEAR=YEAR)
    TORUN2='''python {SCRIPT} {DOFILE} ttW-multilepton/mca-3l-{MCASUFFIX}{MCAOPTION}.txt ttW-multilepton/3l_tight_thq.txt {FUNCTION_SVA_3L} {SYSTS} {OPT_3L} --binname tHq_3l_{YEAR} -E ^thqlike -X ^borthogonality -X ^FRWorthogonality --categorize {CATFUNC} {CATBINS} {CATNAMES}  --year {YEAR};'''.format(SCRIPT=SCRIPT, DOFILE=DOFILE, MCASUFFIX=MCASUFFIX, MCAOPTION=MCAOPTION, FUNCTION_SVA_3L=FUNCTION_SVA_2L_scan, SYSTS=SYSTS, OPT_3L=OPT_3L, CATFUNC=CATFUNC,CATNAMES=CATNAMES, CATBINS=CATBINS,YEAR=YEAR)
    print(submit.format(command=TORUN1))
    print(submit.format(command=TORUN2))
...
if  REGION == "cr_3l":
    ...
    TORUN = '''python {SCRIPT} {DOFILE} ttW-multilepton/mca-3l-{MCASUFFIX}{MCAOPTION}.txt ttW-multilepton/3l_tight_legacy.txt {FUNCTION_CR_3L} {SYSTS} {OPT_3L} --binname ttW_cr_3l_{YEAR} --categorize "{CATFUNC}" {CATBINS} {CATNAMES} --year {YEAR} --fakeName nonprompt'''.format( SCRIPT=SCRIPT, DOFILE=DOFILE, MCASUFFIX=MCASUFFIX,MCAOPTION=MCAOPTION,FUNCTION_CR_3L=FUNCTION_CR_3L,SYSTS=SYSTS,OPT_3L=OPT_3L,YEAR=YEAR,CATFUNC=CATFUNC,CATBINS=CATBINS,CATNAMES=CATNAMES)
    print(submit.format(command=TORUN))
...
if REGION == "cr_4l":
    ...
    CATPOSTFIX="_cr_4l";
    TORUN = 'python {SCRIPT} {DOFILE} ttW-multilepton/mca-4l-{MCASUFFIX}{MCAOPTION}.txt ttW-multilepton/4l_tight.txt {FUNCTION_CR_4L} {SYSTS} {OPT_4L} --binname ttW{CATPOSTFIX}_{YEAR} --year {YEAR} '.format(SCRIPT=SCRIPT, DOFILE=DOFILE,MCASUFFIX=MCASUFFIX,MCAOPTION=MCAOPTION, FUNCTION_CR_4L=FUNCTION_CR_4L,SYSTS=SYSTS,OPT_4L=OPT_4L,CATPOSTFIX=CATPOSTFIX,YEAR=YEAR)
    print(submit.format(command=TORUN))
...
if REGION=="4l_SVA": 
    OPT_4L='{T4L} {OPTIONS} -W "L1PreFiringWeight_Nom*puWeight*btagSF_shape*leptonSF_4l*triggerSF_ttH(LepGood1_pdgId, LepGood1_conePt, LepGood2_pdgId, LepGood2_conePt, 3, year)"'.format(T4L=T4L,OPTIONS=OPTIONS)
    CATPOSTFIX=""
    TORUN="python {SCRIPT} {DOFILE} ttW-multilepton/mca-4l-{MCASUFFIX}{MCAOPTION}.txt ttW-multilepton/4l_tight.txt {FUNCTION_SVA_4L} {SYSTS} {OPT_4L} --binname ttH_4l{CATPOSTFIX}_{YEAR} --year {YEAR}".format(SCRIPT=SCRIPT, DOFILE=DOFILE,MCASUFFIX=MCASUFFIX,MCAOPTION=MCAOPTION,FUNCTION_SVA_4L=FUNCTION_SVA_4L,SYSTS=SYSTS,OPT_4L=OPT_4L,CATPOSTFIX=CATPOSTFIX,YEAR=YEAR)
    print(submit.format(command=TORUN))
