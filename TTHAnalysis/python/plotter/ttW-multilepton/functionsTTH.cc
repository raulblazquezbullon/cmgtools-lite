...
float ttW_3l_SVA_classifier(float nJet25,float nBJetMedium25,int LepGood1_charge, int LepGood2_charge, int LepGood3_charge){
  ...
  if ((nJet25 == 2)*(nBJetMedium25 == 2)) ret = 2;
  if ((nJet25 == 3)*(nBJetMedium25 == 1)) ret = 3;
  if ((nJet25 == 3)*(nBJetMedium25 == 2)) ret = 4;
  if ((nJet25 > 3)*(nBJetMedium25 == 1))  ret = 5;
  if ((nJet25 > 3)*(nBJetMedium25 == 2))  ret = 6;
  if ((LepGood1_charge+LepGood2_charge+LepGood3_charge)>0) ret = ret+6;
  return ret;
}
