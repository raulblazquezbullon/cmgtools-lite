...
for toy in range(1,1000):
  ...
  tl.AddEntry(condNorm, "Norm, yield pull","l")
  ...
  tl.Draw("same")
  c.SaveAs("~/www/plots_bootstrap/conds_all_%i.pdf"%toy)
  c.SaveAs("~/www/plots_bootstrap/conds_all_%i.png"%toy)"""
...
tl = ROOT.TLegend(0.6,0.7,0.9,0.9)
tl.AddEntry(pullsNorm, "Norm, max deviations","l")
...
tl.Draw("same")
c.SaveAs("~/www/plots_bootstrap/maxdev_all.pdf")
c.SaveAs("~/www/plots_bootstrap/maxdev_all.png")
