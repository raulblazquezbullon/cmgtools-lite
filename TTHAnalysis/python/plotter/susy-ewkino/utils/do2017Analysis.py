...
if "friend_" in doWhat:
    baseCommand = "python prepareEventVariablesFriendTree.py  [INTREES] [OUTTREES] --tra2 --tree treeProducerSusyMultilepton --vector -T sf  -m vtxWeight -m vtxWeightUp -m vtxWeightDown -N 100000 -I CMGTools.TTHAnalysis.tools.multilepFriendTreeProducersToCleanup --onlyMC"
