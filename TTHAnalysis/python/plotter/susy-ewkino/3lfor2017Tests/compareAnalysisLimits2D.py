...
""" Example: Running yields comparison
python compareAnalysisLimits2D.py /pool/ciencias/userstorage/carlosec/cardsEWK2017_pre2/_Triggermmm12105/inFile12_10_5 /pool/ciencias/userstorage/carlosec/cardsEWK2017_SOSComp/_Triggermmm12105/inFile12_10_5 --name1 'Inclusive' --name2 'minMll>60'  --mRange 90,410,-5,300 --pdir /nfs/fanae/user/carlosec/www/ewkPlots2017/scansmmmMll/_Triggermmm12105quotmll60  --fom 1_2 --mass1 'm_{#tilde{#chi}_{1}^{#pm}} = m_{#tilde{#chi}_{2}^{0}} [GeV]' --mass2 'm_{#tilde{#chi}_{1}^{0}} [GeV]' --ReBinFactor 5,5 --fillIt 1

python compareAnalysisLimits2D.py /pool/ciencias/userstorage/carlosec/cardsEWK2017_pre2/_Triggermmm12105/inFile12_10_5 /pool/ciencias/userstorage/carlosec/cardsEWK2017_SOSComp/_Triggermmm12105mll50/inFile12_10_5 --name1 'Inclusive' --name2 'minMll>50'  --mRange 90,410,-5,300 --pdir /nfs/fanae/user/carlosec/www/ewkPlots2017/scansmmmMll/_Triggermmm12105quotmll50  --fom 1_2 --mass1 'm_{#tilde{#chi}_{1}^{#pm}} = m_{#tilde{#chi}_{2}^{0}} [GeV]' --mass2 'm_{#tilde{#chi}_{1}^{0}} [GeV]' --ReBinFactor 5,5 --fillIt 1

python compareAnalysisLimits2D.py /pool/ciencias/userstorage/carlosec/cardsEWK2017_pre2/_Triggermmm12105/inFile12_10_5 /pool/ciencias/userstorage/carlosec/cardsEWK2017_SOSComp/_Triggermmm12105mll40/inFile12_10_5 --name1 'Inclusive' --name2 'minMll>40'  --mRange 90,410,-5,300 --pdir /nfs/fanae/user/carlosec/www/ewkPlots2017/scansmmmMll/_Triggermmm12105quotmll40  --fom 1_2 --mass1 'm_{#tilde{#chi}_{1}^{#pm}} = m_{#tilde{#chi}_{2}^{0}} [GeV]' --mass2 'm_{#tilde{#chi}_{1}^{0}} [GeV]' --ReBinFactor 5,5 --fillIt 1


python compareAnalysisLimits2D.py /pool/ciencias/userstorage/carlosec/cardsEWK2017_pre2/_Triggermmm12105/inFile12_10_5 /pool/ciencias/userstorage/carlosec/cardsEWK2017_SOSComp/_Triggermmm12105mll20/inFile12_10_5 --name1 'Inclusive' --name2 'minMll>20'  --mRange 90,410,-5,300 --pdir /nfs/fanae/user/carlosec/www/ewkPlots2017/scansmmmMll/_Triggermmm12105quotmll20  --fom 1_2 --mass1 'm_{#tilde{#chi}_{1}^{#pm}} = m_{#tilde{#chi}_{2}^{0}} [GeV]' --mass2 'm_{#tilde{#chi}_{1}^{0}} [GeV]' --ReBinFactor 5,5 --fillIt 1


python compareAnalysisLimits2D.py /pool/ciencias/userstorage/carlosec/cardsEWK2017_pre2/_Triggermmm12105/inFile12_10_5 /pool/ciencias/userstorage/carlosec/cardsEWK2017_SOSComp/_Triggermmm12105maxmll60/inFile12_10_5 --name1 'Inclusive' --name2 'maxMll>60'  --mRange 90,410,-5,300 --pdir /nfs/fanae/user/carlosec/www/ewkPlots2017/scansmmmMll/_Triggermmm12105quotmaxmll60  --fom 1_2 --mass1 'm_{#tilde{#chi}_{1}^{#pm}} = m_{#tilde{#chi}_{2}^{0}} [GeV]' --mass2 'm_{#tilde{#chi}_{1}^{0}} [GeV]' --ReBinFactor 5,5 --fillIt 1

python compareAnalysisLimits2D.py /pool/ciencias/userstorage/carlosec/cardsEWK2017_pre2/_Triggermmm12105/inFile12_10_5 /pool/ciencias/userstorage/carlosec/cardsEWK2017_SOSComp/_Triggermmm12105maxmll50/inFile12_10_5 --name1 'Inclusive' --name2 'maxMll>50'  --mRange 90,410,-5,300 --pdir /nfs/fanae/user/carlosec/www/ewkPlots2017/scansmmmMll/_Triggermmm12105quotmaxmll50  --fom 1_2 --mass1 'm_{#tilde{#chi}_{1}^{#pm}} = m_{#tilde{#chi}_{2}^{0}} [GeV]' --mass2 'm_{#tilde{#chi}_{1}^{0}} [GeV]' --ReBinFactor 5,5 --fillIt 1

python compareAnalysisLimits2D.py /pool/ciencias/userstorage/carlosec/cardsEWK2017_pre2/_Triggermmm12105/inFile12_10_5 /pool/ciencias/userstorage/carlosec/cardsEWK2017_SOSComp/_Triggermmm12105maxmll40/inFile12_10_5 --name1 'Inclusive' --name2 'maxMll>40'  --mRange 90,410,-5,300 --pdir /nfs/fanae/user/carlosec/www/ewkPlots2017/scansmmmMll/_Triggermmm12105quotmaxmll40  --fom 1_2 --mass1 'm_{#tilde{#chi}_{1}^{#pm}} = m_{#tilde{#chi}_{2}^{0}} [GeV]' --mass2 'm_{#tilde{#chi}_{1}^{0}} [GeV]' --ReBinFactor 5,5 --fillIt 1

python compareAnalysisLimits2D.py /pool/ciencias/userstorage/carlosec/cardsEWK2017_pre2/_Triggermmm12105/inFile12_10_5 /pool/ciencias/userstorage/carlosec/cardsEWK2017_SOSComp/_Triggermmm12105maxmll30/inFile12_10_5 --name1 'Inclusive' --name2 'maxMll>30'  --mRange 90,410,-5,300 --pdir /nfs/fanae/user/carlosec/www/ewkPlots2017/scansmmmMll/_Triggermmm12105quotmaxmll30  --fom 1_2 --mass1 'm_{#tilde{#chi}_{1}^{#pm}} = m_{#tilde{#chi}_{2}^{0}} [GeV]' --mass2 'm_{#tilde{#chi}_{1}^{0}} [GeV]' --ReBinFactor 5,5 --fillIt 1

python compareAnalysisLimits2D.py /pool/ciencias/userstorage/carlosec/cardsEWK2017_pre2/_Triggermmm12105/inFile12_10_5 /pool/ciencias/userstorage/carlosec/cardsEWK2017_SOSComp/_Triggermmm12105maxmll20/inFile12_10_5 --name1 'Inclusive' --name2 'maxMll>20'  --mRange 90,410,-5,300 --pdir /nfs/fanae/user/carlosec/www/ewkPlots2017/scansmmmMll/_Triggermmm12105quotmaxmll20  --fom 1_2 --mass1 'm_{#tilde{#chi}_{1}^{#pm}} = m_{#tilde{#chi}_{2}^{0}} [GeV]' --mass2 'm_{#tilde{#chi}_{1}^{0}} [GeV]' --ReBinFactor 5,5 --fillIt 1
"""

#Parser input
pr = OptionParser(usage="%prog summary1 summary2 [options]")
...
pr.add_option( "--name2", dest = "Arg2" , type = "string", default = "SUS-16-039", help = "Identifier of second summary")
...
class summaryReader():
  def __init__(self, path, name, mode = "Build", rebin = False, rebinFactor = 1, outpath = "./testhisto.root", doWhat = "Plot"):
    ...
    if mode == "Compare":
      ...
      if doWhat == "Plot":
        self.plotComparison()
      if doWhat == "Save":
        fileOut = ROOT.TFile(self.outpath+".root", "RECREATE")
        fileOut.cd()
        self.hCompare.Write()
        fileOut.Close()
  ...
  def getMassPoint(self, masses):
    ...
    if pointNumber > 1:
      ...
      return massPoint(self,masses+[9999,9999,9999,9999,9999],self.massPoints[0].mode) 
  #COMPARE ONLY#
  def compare(self, summary1, summary2):
    for massPoint1 in summary1.massPoints:
      massPoint2 = summary2.getMassPoint([massPoint1.mass1, massPoint1.mass2])
      cond, newPoint = massPoint1.compare(self,massPoint2)
      if cond: self.addMassPoint(newPoint)
  ...
  def getClosestValues(self, i , j , thedistance):
    ...
    isSignalPoint = False
    isBackPoint = False
    if (Rebinning[1]*j-Rebinning[0]*i) < 90:
      isSignalPoint = True
      mLen = 2
  ...
  def plotComparison(self):   
    ...
    self.hCompare.GetZaxis().SetTitle("(Yields "+str(Arg2)+")/(Yields "+str(Arg1)+")")
    ...
    self.hCompare.SetMinimum(0.0)
    self.hCompare.SetMaximum(1.0)
    #4 Color Palette
    NRGBs = 5
    NCont = 255
...
class massPoint():
  ...
  def compare(self, newSummary, anotherMassPoint):
    if self.mode != anotherMassPoint.mode and verbosity > 0: print "WARNING: YOU MIGHT BE COMPARING DIFFERENT FIGURES OF MERIT, CHECK SUMMARY MODES"
    if (self.val < 0.00001 and anotherMassPoint.val < 0.000001) or (self.val > 100000 and anotherMassPoint.val > 100000):
      return False, 0
    if self.val < 0.000001: 
      self.val = 0.00001
    if anotherMassPoint.val < 0.00001: 
      anotherMassPoint.val = 0.00001
    if self.val > anotherMassPoint.val:
      return True, massPoint(newSummary,[self.mass1,self.mass2],"Compare",[anotherMassPoint.val*1./self.val*1.,"r."]) 
    elif self.val < anotherMassPoint.val:
      return True, massPoint(newSummary,[self.mass1,self.mass2],"Compare",[anotherMassPoint.val*1./self.val*1.,"g."]) 
    elif self.val == anotherMassPoint.val:
      return True, massPoint(newSummary,[self.mass1,self.mass2], "Compare",[1.,"y."])




#Run the whole comparison
summary1 = summaryReader(args[0],Arg1)
