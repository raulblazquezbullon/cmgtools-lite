...
if __name__ == "__main__":
    ...
    for var in variables:
        ...
        for nq in nquant:
            ...
            cmd5 = "cd %s; combineTool.py -M MultiDimFit --algo grid --points 200 --rMin 0 --rMax 6 -m 125 higgsCombinebestfit.MultiDimFit.mH125.root %s --freezeParameters allConstrainedNuisances --snapshotName MultiDimFit --redefineSignalPOI r_prompt_WZ -n _stat --job-mode slurm --sub-opts='-p batch'; cd -" %(inpath,doBlind)
