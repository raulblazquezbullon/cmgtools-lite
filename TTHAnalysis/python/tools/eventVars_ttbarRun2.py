...
from CMGTools.TTHAnalysis.tools.nanoAOD.ttbarRun2_modules import ch, tags


class EventVars_ttbarRun2(Module):
    def __init__(self, label = "", recllabel = 'Recl', isMC = True,
        ...
        for delta,var in self.systsJEC.items():   self.branches.extend([br + self.label + var for br in self.jecbranches])
