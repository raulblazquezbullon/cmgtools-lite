...
#### Settings
friendspath = "/pool/phedexrw/userstorage/andreatf/proyectos/ttbar_run2/productions"
...
prodname    = "2021-02-22" # tras la prueba, todo aparentemente en orden; BUENA
#prodname    = "2020-09-23" # validacion cramonal


datasamples  = ["SingleMuon", "SingleElec", "DoubleMuon", "DoubleEG", "MuonEG", "EGamma"]
...
commandscaff = "python prepareEventVariablesFriendTree.py -t NanoAOD {inpath} {outpath} -I CMGTools.TTHAnalysis.tools.nanoAOD.ttbarRun2_modules {module} {friends} {dataset} -N {chunksize} {cluster} {ex}"
...
sampledict[2016] = {
    ...
    ### WZ
    "WZTo2L2Q"             : "Tree_WZTo2L2Q_amcatnloFXFX_madspin_",
